...
export function TransactionsPage() {
  ...
  const visibleTransactions = finalTransactions.slice(
    0,
    parseInt(pageSize)
  );
            ...
            <div className='overflow-y-auto max-h-[calc(100vh-16rem)]'>
              <div className='overflow-x-auto min-w-full inline-block align-middle'>
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead className='min-w-[250px] sticky left-0 bg-background'>
                        Descripción + Origen
                      </TableHead>
                      ...
                      <TableHead className='min-w-[100px] sticky right-0 bg-background'>
                        Acciones
                      </TableHead>
                    </TableRow>
                  </TableHeader>
